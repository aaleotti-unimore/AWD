...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
if ischar(Sistema)                  % Se Sistema è una strina ...
...
switch Ramo_ii.Nome_Ramo
    ...
    case 'iU'                       % Generatore IDRAULICO
        ...
        DISEGNA_SCATOLA(P3,P4,P5,P6,Opzioni)
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    case {'iC','iK'}                % Capacità Idraulica C e rigidezza igraulica K
        Ratio_Larg=0.5;             % Ratio_Larg = Larghezza_dell'elemento/Lung
            ...
            case {'Kn','Qn','En','Fn'}          % Per questi comandi ...
                ...
                switch Nome
                    ...
                    case {'eV','mV','rW','iP'}
                        ...
                        if not(isempty(Pnt))        % Se '=' è presente ...
                            if strcmp(Cmd,'En')
...
for hh=0:length(Parms)
    ...
    if OK   % Vengono copiati solo i parametri Show_It='Si'
        ...
        for kk=[1:Ind_Show_It-1 Ind_Show_It+1:length(Indice)] % La colonna "Show_It" non viene copiata 
            ...
            if isstr(Parametro)                                 % Se il parametro è una stringa
                Parametro=strrep(Parametro,'''',' ');           % ... si tolgono gli accenti
                Parametro=strrep(Parametro,';',Separa_Set);     % ... il separatore ';' è sostituito con ','
            end
            switch Indice{kk}
                case {'Range_and_Set'}
                    if hh==0
...
for ii=1:Sistema.Nr_dei_Rami
    ...
    switch Tipo_di_Ramo
        case 'Ingresso'
            if isempty(Ramo_ii.TR_o_GY)     % Se il blocco è un vero ingresso ...
            ...
            else                    % Se il blocco è un trasformatore o un giratore  ...
